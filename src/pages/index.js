    ...
    return (
      <div>
        <section css={` margin-bottom: ${rhythm(2)}; `}>
          ...
          <p css={` font-weight: 700; `}>A word from Elixir's Creator</p>
          <p css={` color: ${consts.orange}; font-family: "OdudoMono-Regular", sans-serif; line-height: 37px; letter-spacing: 0.3px;`}>
        ...
        <SectionWrapper header="About Us" subhead="A message from conference organizer Bruce Tate.">
          <p>
        ...
        <SectionWrapper header="Get Notified When Tickets Go Live" subhead="As well as infrequent announcements and info.">
          <span css={` font-family: "OdudoMono-Regular", sans-serif; color: ${consts.orange}; font-size: 20px; `}>
        ...
        <SectionWrapper header="Scholarships" subhead="Because we're stronger together.">
          <p>
        ...
        <SectionWrapper header="Registration" subhead="Join us at Gig City Elixir 2018!">
          <p css={` font-family: "OdudoMono-Regular", sans-serif; color: ${consts.purple}; font-size: 30px; `}>
            $350 Individual // $450 Corporate
          </p>
          <button css={` background-color: ${consts.orange} `}>Registration Coming Soon</button>
        </SectionWrapper>
      </div>
    )
  }
